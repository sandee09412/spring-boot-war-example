    ...
    stages {
        ...
        stage("Deploy on Test"){
            steps{
                ...
                deploy adapters: [tomcat9(credentialsId: 'tomcatserverdetails', path: '', url: 'http://13.235.133.154:8080')], contextPath: '/app', war: '**/*.war'
        ...
        stage("Deploy on Prod"){
            ...
            steps{
                ...
                deploy adapters: [tomcat9(credentialsId: 'tomcatserverdetails', path: '', url: 'http://13.126.76.50:8080')], contextPath: '/app', war: '**/*.war'
